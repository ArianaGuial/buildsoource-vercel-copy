...
export default function Materials() {
    ...
    return (
        <div>
            ...
            <section className="list-view">
                {/* Material Items */}
                {['cement', 'steel-rebar', 'clay-bricks'].map((material) => (
                    <div key={material} className="material-list-item">
                        <div className="material-image">
                            <Image src={`/img/${material}.png`} alt={material} width={200} height={200} />
                        </div>
                        <div className="material-content">
                            <h2>{material.replace('-', ' ').replace(/\b\w/g, c => c.toUpperCase())}</h2>
                            <p>Description for {material}</p>
                            <button className="view-details-btn" onClick={() => openModal(material)}>View Details</button>
                        </div>
                    </div>
                ))}
            </section>
